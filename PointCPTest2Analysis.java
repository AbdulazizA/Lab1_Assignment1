...
public class PointCPTest2Analysis {
	public static void main(String[] args) {
		...
		PointCP2[] points = new PointCP2[1000000];
		...
		for(int j = 0; j < 1000000; j++) {
			points[j] = new PointCP2(types[j], rhos[j], thetas[j]);
		}
		...
		PointCP2 point2 = new PointCP2(random.nextBoolean() ? 'C' : 'P', Math.random()*1000, Math.random()*1000);
		start = System.currentTimeMillis();
		for(int i = 0; i < 1000000; i++) {
